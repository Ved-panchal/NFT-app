...
// deployed address 0xbE86e569b08b8F66d24724B11B8e11FB177319aC

contract Ved is ERC721Enumerable, Ownable {
    ...
    function payToMint() public payable {
        ...
        require(!paused,"NFTs are under Maintenance.");
        require(supply <= maxSupply,"Sorry, All NFTs are minted.");
